const {
  ...
  // -----------------------------------------------------------------------------------------------
  // BEGIN import { toTrianglesDrawMode } from '../utils/BufferGeometryUtils.js';
  // -----------------------------------------------------------------------------------------------
  const { Float32BufferAttribute, InstancedBufferAttribute, TrianglesDrawMode } = THREE;
  ...
  // END import { toTrianglesDrawMode } from '../utils/BufferGeometryUtils.js';
  // -----------------------------------------------------------------------------------------------
